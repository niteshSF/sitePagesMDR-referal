function newDashboard(key, value) {
  ...
  const sizes = {
    Documents: { width: "700px", height: "270px" }, // Double size
    Articles: { width: "260px", height: "200px" },
    Books: { width: "260px", height: "200px" },
    Manuscripts: { width: "380px", height: "200px" },
...
// in dashboard, document structure is big (adjusted from here)
  ...
  if (key === "Documents") {
  divColmd2.className = "col-md-2 w-[370px] mt-28 mr-28";

  h4cardtitle = document.createElement("h4");
  h4cardtitle.className = "bg-yellow-900 bg-opacity-50 rounded-xl px-2 h-11 w-72 text-center flex items-center justify-center text-white font-bold text-3xl";
  h4cardtitle.innerHTML = key;

  h3cardcount = document.createElement("h3");
  h3cardcount.className = "bg-yellow-900 bg-opacity-50 rounded-xl px-2 h-11 w-48 text-center flex items-center justify-center text-white font-bold text-3xl";
  h3cardcount.innerHTML = value;

} else {
  divColmd2.className = "col-md-2 -mt-2 w-[250px]";

  h4cardtitle = document.createElement("h4");
  h4cardtitle.className = "bg-yellow-950 bg-opacity-100 rounded-xl px-2 h-11 w-52 text-center flex items-center justify-center text-white font-semibold text-2xl";
  h4cardtitle.innerHTML = key;

  h3cardcount = document.createElement("h3");
  h3cardcount.className = "bg-yellow-950 bg-opacity-100 rounded-xl px-2 h-10 w-32 text-center flex items-center justify-center text-white font-bold text-2xl";
  h3cardcount.innerHTML = value;
}
